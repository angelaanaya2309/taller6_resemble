...
app.get('/runtest', (req, res) => {
  cypress.run({
    spec: './Cypress_color/integration/color_pallete.js'
  })
  .then((results) => {
    regression(res);
  })
...
function regression(res) {
  let img1 = '/Cypress_color/screenshots/test.spec.js/Test Color -- Cambio de color.png';
  let img2 = '/Cypress_color/screenshots/test.spec.js/Test Color -- Cambio de color (1).png';
